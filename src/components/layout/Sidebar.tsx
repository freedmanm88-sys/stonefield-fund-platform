...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: 'Operations',
    items: [
      { name: 'Calculations', href: '/dashboard/calculations', icon: CalculatorIcon, comingSoon: true },
      { name: 'PAD Files', href: '/dashboard/pad-files', icon: FileIcon, comingSoon: true },
      { name: 'Reports', href: '/dashboard/reports', icon: ChartIcon, comingSoon: true },
      { name: 'Reconciliation', href: '/dashboard/reconciliation', icon: CheckCircleIcon, comingSoon: true },
      { name: 'Expenses', href: '/dashboard/expenses', icon: ReceiptIcon, comingSoon: true },
    ],
  },
  {
    label: 'Administration',
    items: [
      { name: 'Settings', href: '/dashboard/settings', icon: CogIcon, comingSoon: true },
    ],
  },
]
    ...
    <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-gray-200">
      ...
      <div className="flex items-center gap-2 px-6 h-16 border-b border-gray-200">
        ...
        <div className="min-w-0">
          <p className="text-sm font-semibold text-brand-black truncate">Stonefield Capital</p>
          <p className="text-xs text-gray-400">Fund Platform</p>
        </div>
      </div>
