      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">MIC Fund Management Platform</p>
          </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="you@stonefieldcapital.ca"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-brand-blue text-white rounded-lg font-medium hover:bg-brand-blue-hover transition-colors disabled:opacity-50 text-sm"
            >
